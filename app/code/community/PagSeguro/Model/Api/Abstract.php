 ...
 */
abstract class PagSeguro_Model_Api_Abstract extends Varien_Object
{
    ...
    {
        if (!$this->hasData($key)) {
             $value = Mage::getStoreConfig('pagseguro/wpp/'.$key);
    ...
    {
        return Mage::getUrl($this->getConfigData('api_error_url', 'pagseguro/express/error'));
    }
    ...
    {
        return Mage::getUrl($this->getConfigData('api_cancel_url', 'pagseguro/express/cancel'));
    }
    ...
    {
        $types = array('AE'=>Mage::helper('pagseguro')->__('Amex'), 'VI'=>Mage::helper('pagseguro')->__('Visa'), 'MC'=>Mage::helper('pagseguro')->__('MasterCard'), 'DI'=>Mage::helper('pagseguro')->__('Discover'));
